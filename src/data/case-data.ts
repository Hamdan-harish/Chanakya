export type EntityKind =
  "person" | "phone" | "account" | "vehicle" | "location" | "organization" | "social";

export type RelKind = "CALLS" | "TRANSFERS" | "OWNS" | "VISITED" | "ASSOCIATED WITH" | "MEMBER OF";
...
export const ENTITY_KIND_META: Record<
  ...
  {
    label: string;
    shape: "circle" | "square" | "diamond" | "hex" | "pill" | "triangle";
    token: string;
  }
> = {
...
export const NODES: EntityNode[] = [
  ...
  // --- Locations ---
  {
    id: "l-kochi",
    kind: "location",
    label: "Kochi — Warehouse 7",
    alert: "high",
    cluster: "Kochi core",
    x: 430,
    y: 470,
    sources: ["SUR-07", "FIR-02"],
    confidence: 91,
  },
  {
    id: "l-blr",
    kind: "location",
    label: "Bengaluru — Yeshwanthpur",
    alert: "medium",
    cluster: "Transport",
    x: 960,
    y: 760,
  ...
  // --- Organizations ---
  {
    ...
    sub: "Registered freight firm",
    alert: "medium",
    cluster: "Transport",
    x: 900,
    y: 250,
    sources: ["FIR-05", "TXN-027"],
    confidence: 78,
  },
  {
    id: "o-trade",
    kind: "organization",
    label: "Anchor Trading Co.",
    sub: "Import/export",
    alert: "low",
    cluster: "Mumbai node",
    x: 1330,
  ...
  },
  {
    id: "o-coop",
    kind: "organization",
    label: "Coastal Welfare Society",
    sub: "Registered society",
    alert: "none",
    cluster: "Finance ring",
    x: 130,
    y: 720,
...
export const EDGES: EntityEdge[] = [
  {
    ...
    kind: "OWNS",
    confidence: 96,
    detail: "Subscriber record matches FIR statement.",
    source: "CDR-114",
  },
  {
    id: "e2",
    ...
    kind: "OWNS",
    confidence: 92,
    detail: "Handset IMEI consistently paired.",
    source: "CDR-114",
  },
  {
    id: "e3",
    ...
    confidence: 94,
    count: 61,
    detail: "61 calls across 22 days; 17 within a 15-minute window on 12 Aug.",
    source: "CDR-114",
    suspicious: true,
  },
  {
    ...
    confidence: 88,
    detail: "Co-located at Marine Cafe on three occasions.",
    source: "SUR-03",
  },
  {
    id: "e5",
    ...
    kind: "OWNS",
    confidence: 90,
    detail: "Registration matches investigator note.",
    source: "SUR-07",
  },
  {
    id: "e6",
    ...
    confidence: 87,
    count: 6,
    detail: "Six sightings at Warehouse 7 between 04–14 Aug.",
    source: "SUR-07",
  },
  {
    id: "e7",
    ...
    confidence: 89,
    count: 9,
    detail: "9 outbound transfers totalling ₹4.6 lakh.",
    source: "TXN-019",
    suspicious: true,
  },
  {
  ...
  },
  {
    ...
    confidence: 91,
    count: 14,
    detail: "14 transfers, several within 40 minutes of call events.",
    source: "TXN-014",
    suspicious: true,
  },
  {
  ...
  },
  {
    ...
    confidence: 85,
    count: 23,
    detail: "23 calls, mostly preceding transfer events.",
    source: "CDR-118",
    suspicious: true,
  },
  {
    ...
    kind: "OWNS",
    confidence: 86,
    detail: "Account holder of record.",
    source: "TXN-022",
  },
  {
    id: "e13",
    ...
    confidence: 79,
    count: 4,
    detail: "Four round-figure transfers.",
    source: "TXN-022",
  },
  {
    id: "e14",
    ...
    kind: "MEMBER OF",
    confidence: 64,
    detail: "Listed member in society register.",
    source: "FIR-02",
  },
  {
    id: "e15",
    ...
    confidence: 83,
    count: 7,
    detail: "Layered transfers via Harbour Bank.",
    source: "TXN-027",
    suspicious: true,
  },
  {
  ...
  },
  {
    ...
    kind: "OWNS",
    confidence: 88,
    detail: "Registration linked to surveillance sighting.",
    source: "SUR-07",
  },
  {
    id: "e18",
    ...
    confidence: 84,
    count: 3,
    detail: "Van observed at Warehouse 7 on 07, 09 and 12 Aug.",
    source: "SUR-07",
    suspicious: true,
  },
  {
    ...
    confidence: 80,
    count: 2,
    detail: "Two sightings at Yeshwanthpur yard.",
    source: "SUR-11",
  },
  {
    id: "e20",
  ...
  },
  {
    ...
    confidence: 78,
    count: 12,
    detail: "12 calls clustered around movement events.",
    source: "CDR-140",
  },
  {
    id: "e22",
    ...
    kind: "OWNS",
    confidence: 71,
    detail: "Unregistered SIM, handset attribution.",
    source: "CDR-140",
  },
  {
    id: "e23",
    ...
    confidence: 76,
    count: 18,
    detail: "18 short-duration calls.",
    source: "CDR-140",
  },
  {
    id: "e24",
    ...
    kind: "VISITED",
    confidence: 73,
    detail: "Observed at yard entrance.",
    source: "SUR-11",
  },
  {
    id: "e25",
    ...
    kind: "MEMBER OF",
    confidence: 77,
    detail: "Listed as contract driver.",
    source: "FIR-05",
  },
  {
    id: "e26",
    ...
    confidence: 74,
    count: 5,
    detail: "Freight payments to driver account.",
    source: "TXN-027",
  },
  {
    id: "e27",
    ...
    kind: "ASSOCIATED WITH",
    confidence: 75,
    detail: "Named in freight documentation.",
    source: "FIR-05",
  },
  {
    id: "e28",
  ...
  },
  {
    ...
    confidence: 81,
    count: 27,
    detail: "27 calls; burst pattern on 12 Aug.",
    source: "CDR-133",
    suspicious: true,
  },
  {
    ...
    confidence: 72,
    count: 6,
    detail: "Six transfers to Anchor Trading.",
    source: "TXN-031",
  },
  {
    id: "e31",
  ...
  },
  {
    ...
    kind: "OWNS",
    confidence: 65,
    detail: "Profile handle matches alias.",
    source: "SOC-06",
  },
  {
    id: "e33",
    ...
    kind: "ASSOCIATED WITH",
    confidence: 68,
    detail: "Repeated tagged posts at shared locations.",
    source: "SOC-04",
  },
  {
    id: "e34",
    ...
    kind: "OWNS",
    confidence: 72,
    detail: "Handle linked via phone recovery hint.",
    source: "SOC-04",
  },
  {
    id: "e35",
    ...
    kind: "OWNS",
    confidence: 84,
    detail: "Alias 'Ravi_87' matches FIR alias and posted vehicle image.",
    source: "SOC-01",
    suspicious: true,
  },
  {
    ...
    kind: "MEMBER OF",
    confidence: 61,
    detail: "Member of transit coordination group.",
    source: "SOC-09",
  },
  {
    id: "e37",
    ...
    kind: "MEMBER OF",
    confidence: 60,
    detail: "Shared group membership.",
    source: "SOC-09",
  },
  {
    id: "e38",
    ...
    confidence: 62,
    count: 3,
    detail: "Three observed meetings.",
    source: "SUR-03",
  },
  {
    id: "e39",
    ...
    kind: "VISITED",
    confidence: 55,
    detail: "Witness statement places him nearby.",
    source: "FIR-02",
  },
  {
    id: "e40",
    ...
    kind: "ASSOCIATED WITH",
    confidence: 49,
    detail: "Witness identifies subject.",
    source: "FIR-02",
  },
  {
    id: "e41",
    ...
    kind: "ASSOCIATED WITH",
    confidence: 47,
    detail: "Frequent contact, no financial linkage.",
    source: "CDR-118",
  },
  {
    id: "e42",
    ...
    confidence: 44,
    count: 5,
    detail: "Five calls, routine pattern.",
    source: "CDR-121",
  },
  {
    id: "e43",
  ...
  },
  {
    ...
    confidence: 69,
    count: 2,
    detail: "Two sightings near dock gate.",
    source: "SUR-14",
  },
  {
    id: "e45",
    ...
    kind: "OWNS",
    confidence: 66,
    detail: "Registration attribution pending confirmation.",
    source: "SUR-14",
  },
  {
    id: "e46",
    ...
    kind: "VISITED",
    confidence: 64,
    detail: "Single sighting, plate partially obscured.",
    source: "SUR-14",
  },
  {
    id: "e47",
    ...
    kind: "ASSOCIATED WITH",
    confidence: 40,
    detail: "Vehicle parked at same premises.",
    source: "SUR-09",
  },
  {
    id: "e48",
    ...
    confidence: 71,
    count: 4,
    detail: "Four sightings at warehouse.",
    source: "SUR-07",
  },
  {
    id: "e49",
    ...
    kind: "ASSOCIATED WITH",
    confidence: 58,
    detail: "Repeated same-week movement corridor.",
    source: "SUR-11",
  },
  {
    id: "e50",
...
export const RECENT_ACTIVITY = [
  {
    time: "12:46",
    who: "Insp. A. Verma",
    what: "Exported investigation report",
    ctx: "OP-2026-001",
  },
  {
    time: "12:44",
    who: "Insp. A. Verma",
    what: "Reviewed entity merge suggestion",
    ctx: "Ramesh Kumar / R. Kumar",
  },
  ...
  { time: "11:58", who: "Insp. S. Menon", what: "Uploaded cdr_august.csv", ctx: "OP-2026-002" },
  {
    time: "11:20",
    who: "System",
    what: "Pattern analysis completed — 7 findings",
    ctx: "OP-2026-001",
  },
];
...
export const PATTERNS: Pattern[] = [
  {
    ...
    reason:
      "17 calls between 6 handsets inside 15 minutes, followed by three transfers within the hour.",
    confidence: 91,
    sources: 3,
  ...
  },
  {
    ...
    window: "04–14 Aug",
    reason:
      "₹18.4 lakh moved through 7 accounts in layered round-figure transfers with short dwell time.",
    confidence: 84,
    sources: 2,
  ...
  },
  {
    ...
    window: "07–18 Aug",
    reason:
      "Same vehicle observed on the Kochi → Bengaluru → Mumbai corridor on three consecutive weeks.",
    confidence: 78,
    sources: 2,
  ...
  },
  {
    ...
    window: "04–20 Aug",
    reason:
      "Social handle '@Ravi_87' shares alias, vehicle image and location with an FIR-named subject.",
    confidence: 69,
    sources: 3,
...
export const TIMELINE: TimelineEvent[] = [
  {
    ...
    time: "09:42",
    kind: "Call",
    title: "Call · Ravi Kumar → Amit Sasi",
    detail: "Duration 4m 12s",
    source: "CDR-114",
    focus: ["ph-1", "ph-2"],
  },
  {
  ...
  },
  {
    ...
    detail: "Witness statement naming subject and alias",
    source: "FIR-02",
    focus: ["p-ravi", "p-jose"],
  },
  {
    ...
    time: "18:30",
    kind: "Location",
    title: "Vehicle sighting · KA-05-MJ-7781",
    detail: "Kochi — Warehouse 7",
    source: "SUR-07",
    focus: ["v-2", "l-kochi"],
  },
  {
    ...
    time: "19:04",
    kind: "Call",
    title: "Call · Amit Sasi → Tariq Sheikh",
    detail: "Duration 1m 03s",
    source: "CDR-133",
    focus: ["ph-2", "ph-5"],
  },
  {
    ...
    time: "13:15",
    kind: "Transaction",
    title: "Transfer ₹80,000",
    detail: "Ravi Kumar → A/C 7712",
    source: "TXN-019",
    focus: ["p-ravi", "ac-c"],
  },
  {
    ...
    time: "22:05",
    kind: "Social",
    title: "Post by @Ravi_87",
    detail: "Image containing vehicle KL-07-AB-1234",
    source: "SOC-01",
    focus: ["s-ravi87", "v-1"],
  },
  {
    ...
    detail: "17 calls across 6 handsets in 15 minutes",
    source: "CDR-114",
    focus: ["ph-1", "ph-2", "ph-3", "ph-4"],
    flagged: true,
  },
  {
    day: "12 AUG",
    time: "19:22",
    kind: "Transaction",
    title: "Transfer ₹1,20,000",
    detail: "A/C 7712 → A/C 8845",
    source: "TXN-027",
    focus: ["ac-c", "ac-e"],
    flagged: true,
  },
...
export const AUDIT_LOG = [
  {
    ...
    user: "Insp. A. Verma",
    action: "Export",
    object: "Investigation report (PDF)",
    caseId: "OP-2026-001",
  },
  {
    time: "12:44:52",
    user: "Insp. A. Verma",
    action: "Review",
    object: "Entity merge · Ramesh Kumar",
    caseId: "OP-2026-001",
  },
  {
    time: "12:43:31",
  ...
  },
  {
    ...
    user: "System",
    action: "Analysis",
    object: "Pattern analysis completed (7 findings)",
    caseId: "OP-2026-001",
  },
  {
    time: "12:18:44",
  ...
  },
  {
    ...
    user: "Insp. A. Verma",
    action: "Filter",
    object: "Network filter · Financial only",
    caseId: "OP-2026-001",
  },
  {
    time: "10:22:12",
    user: "Admin",
    action: "Access",
    object: "Role granted · Insp. K. Nair",
    caseId: "—",
  },
  {
    time: "09:05:47",
